    ...
    return(
        ...
        <lable className="border  p-4 flex rounded-2xl gap-2 items-center curser-pointer ">
              ...
              <lable className="border mt-2 p-4 flex rounded-2xl gap-2 items-center curser-pointer ">
              <input type="checkbox" checked ={selected.includes ('FreeParking')} name="FreeParking" onChange={handleCbClick} />
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              ...
              <lable className="border p-4 flex rounded-2xl gap-2 items-center">
              <input type="checkbox" checked ={selected.includes ('PrivateEnterance')} name="PrivateEnterance" onChange={handleCbClick} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
